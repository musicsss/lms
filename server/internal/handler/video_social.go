...
func NewVideoSocialHandler(db *gorm.DB, videoRepo data.VideoSocialRepo, fileRepo data.FileRepo) *VideoSocialHandler {
	return &VideoSocialHandler{db: db, videoRepo: videoRepo, fileRepo: fileRepo}
}
